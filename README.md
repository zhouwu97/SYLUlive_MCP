...
```powershell
uvx --from "git+https://github.com/zhouwu97/SYLUlive_MCP.git@rhinobird/hy3-campus-copilot" hy3-campus-decision-mcp --version
```

启动真实 MCP 子进程，完成 `initialize`、`tools/list` 和四个核心工具调用：

```powershell
uvx --from "git+https://github.com/zhouwu97/SYLUlive_MCP.git@rhinobird/hy3-campus-copilot" hy3-campus-decision-mcp --selfcheck
```
...
```json
{
  "mcpServers": {
    "hy3-campus-decision": {
      ...
      "args": [
        "--from",
        "git+https://github.com/zhouwu97/SYLUlive_MCP.git@rhinobird/hy3-campus-copilot",
